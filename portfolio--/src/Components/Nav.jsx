...
const Nav = () => {
  ...
  return (
    <nav>
      <div className="h-10vh flex justify-between z-50 text-white lg:py-5 px-20 py-4 border-b border-slate-500">
          ...
          <div className="flex-10">
            <ul className="flex gap-8 mr-16 text-[18px]">
              ...
              <Link spy={true} smooth={true} to="Stack">
                <li className="hover:text-fuchsia-600 transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer">Stack</li>
              </Link>
              <Link spy={true} smooth={true} to="Projects">
